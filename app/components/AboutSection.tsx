...
const STRENGTHS = [
  {
    ...
    title: '医療現場を知っている',
    description:
      '健康診断システムの開発・保守10年以上。「現場で使われないシステム」を作らないための視点を持っています。',
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto">
            本職では今も紙運用が現役で動いています。システム部門にいると、どうしても優先度の高い案件から手をつけることになる。個人クリニックの「この業務を変えたい」は、なかなか番が回ってきません。そのもどかしさから、自分で動くことにしました。
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              医療機関のシステム部門で10年以上、健診システムの開発・保守を担当してきました。今も現場では何十年前から変わらない紙の運用が動いています。
            </p>
            <p className="text-gray-600 leading-relaxed">
